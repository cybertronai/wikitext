"""Modal launcher for the diffusionblocks_ar selfattn debug.
...
Usage:
    modal run research/debug/diffusionblocks_ar_selfattn/run_modal.py \\
        --steps 12000
...
app = modal.App("dblocks-ar-selfattn")
