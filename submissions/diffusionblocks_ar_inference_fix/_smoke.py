...
Run from repo root:
    PYTHONPATH=. python submissions/diffusionblocks_ar_inference_fix/_smoke.py
"""
...
os.environ.setdefault("DBLOCKS_N_STEPS", "8")  # small N keeps smoke fast

import submissions.diffusionblocks_ar_inference_fix.submission as sub
